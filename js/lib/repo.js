...
function toMilestoneRow(m, familyId) {
  return {
    ...
    estimated_minutes: Number.isFinite(m.estimatedMinutes) ? m.estimatedMinutes : null,
...
export function fromMilestoneRow(r) {
  return {
    ...
    dueDate: r.due_date,
    estimatedMinutes: Number.isFinite(r.estimated_minutes) ? r.estimated_minutes : null,
