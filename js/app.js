...
import { renderChildPortal, renderChildLogin, renderChildProjectHQ, renderChildCalendar, renderChildPlan, renderChildProjects, renderChildSettings } from "./views/childPortal.js";
...
registerRoute("/kid/:code/plan",     (c, p) => withChildShell(c, renderChildPlan, p));
registerRoute("/kid/:code/projects", (c, p) => withChildShell(c, renderChildProjects, p));
registerRoute("/kid/:code/settings", (c, p) => withChildShell(c, renderChildSettings, p));
